...
type AssignmentsListType = Assignment & {lesson:{
    subject:Subject;
    class:Class;
    teacher:Teacher;
}}
const renderRow = (item: AssignmentsListType) => (
...
export default async function AssignmentsList({ searchParams, }: { searchParams?: { [key:string] : string | undefined } }) {

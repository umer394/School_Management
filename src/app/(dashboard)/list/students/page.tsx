...
type StudentListType = Student & {class:Class}
const renderRow = (item: StudentListType) => (
...
export default async  function StudentsList({ searchParams, }:  { searchParams: Promise<{ [key:string]:string| undefined}>  }) {

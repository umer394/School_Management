...
type ClassesListType = Class & {supervisor:Teacher}

const renderRow = (item: ClassesListType) => (
...
export default async function ClassesList({ searchParams, }: { searchParams: Promise<{ [key:string]:string| undefined}>  }) {

...
type SubjectListType = Subject & {teachers:Teacher[]}

const renderRow = (item: SubjectListType) => (
...
export default async function SubjectList({ searchParams, }:  { searchParams: Promise<{ [key:string]:string| undefined}>  }) {

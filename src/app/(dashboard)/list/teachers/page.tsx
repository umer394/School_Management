...
type TeacherListType = Teacher & {subjects:Subject[]} & {classes:Class[]}
...
export default async function TeacherList({ searchParams, }:  { searchParams: Promise<{ [key:string]:string| undefined}>  }) {

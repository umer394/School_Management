  ...
  return (
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
     ...
     <div className="flex flex-col lg:flex-row gap-4">
        {/* User Info Card */}
        <div className="bg-lamaSky py-6 px-3 rounded-md flex-1 flex gap-4">
            <div className="w-1/3">
                <Image src={"/avatar.png"} alt={""} width={144} height={144} className="w-36 h-36 rounded-full object-cover"/>
            </div>

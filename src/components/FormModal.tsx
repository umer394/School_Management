...
export default function FormModal({ table, type, data, id }: {
    ...
    return (
        <>
            ...
            {open && <div className="w-screen h-screen fixed left-0 top-0  bg-black bg-opacity-60 z-50 flex items-center justify-center">
                <div className="bg-white p-4 rounded-md overflow-y-auto relative w-[70%]    xl:w-[50%] 2xl:w-[40%] ">
                    <Form/>
